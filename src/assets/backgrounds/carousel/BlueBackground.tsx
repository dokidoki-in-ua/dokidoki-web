const BlueBackground = () => {
    return (
        <div
            className={`opacity-1 absolute bottom-0 left-0 right-0 top-0 z-0 overflow-hidden bg-gradient-to-r from-[#2b9eb8bf] via-[#4e60bd] to-[#2ecfcca6] duration-500 ease-in-out`}
        >
            <svg
                className='absolute h-[1200px]'
